//MODIFICADO para imprimir a mensagem ao apertar um botão no FPGA Tang Nano
module uart_test(
	input                        clk,
	input                        rst,
	input                        uart_rx,
...
// Sincroniza e detecta borda de descida no botão
reg btn_d0, btn_d1;
always @(posedge clk) begin
    btn_d0 <= btn;
    btn_d1 <= btn_d0;
end
wire btn_pressed = (btn_d1 == 1'b1 && btn_d0 == 1'b0);
